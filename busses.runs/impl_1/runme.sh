...
HD_PWD='C:/Users/Zach/Development/busses/busses.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log busloader.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source busloader.tcl -notrace
