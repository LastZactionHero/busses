...
read_verilog -library xil_defaultlib {
  ...
  C:/Users/Zach/Development/busses/busses.srcs/sources_1/new/register_loader.v
}
...
synth_design -top register_loader -part xc7a35ticsg324-1L


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef register_loader.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file register_loader_utilization_synth.rpt -pb register_loader_utilization_synth.pb"
