...
HD_PWD='C:/Users/Zach/Development/busses/busses.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log register_loader.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source register_loader.tcl -notrace
